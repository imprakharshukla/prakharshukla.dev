                ...
                <div className={"flex items-center justify-between container mx-auto"}>
                    ...
                    <div>
                        <Link href={"https://prakharshukla.dev/kofi"}
                              className='block hover:translate-x-1 w-fit px-6 py-2 text-lg font-medium text-white transition duration-200 ease-in-out transform bg-gray-100 rounded-lg shadow-md hover:bg-gray-200 focus:shadow-outline focus:outline-none focus:ring-2 text-indigo-500 ring-offset-current ring-offset-2'
                        >
